...
const blogArticles = [
  {
    ...
    tag: "Bitcoin RDC",
    description: "Un guide simple pour comprendre le BTC, verifier les frais, choisir un canal fiable et commencer avec prudence."
  },
  {
    title: "Binance P2P explique simplement",
    href: "/blog/binance-p2p-explique-simplement",
    tag: "Binance P2P",
    description: "Les bases du P2P, les annonces, les preuves Mobile Money et les bons reflexes avant de confirmer une operation."
  },
  {
    title: "Les erreurs a eviter quand on debute en crypto",
    href: "/blog/erreurs-debutant-crypto",
    tag: "Securite",
    description: "Faux supports, mauvais reseaux, promesses rapides: les pieges courants et comment les eviter avec methode."
  }
];
...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen max-w-[100vw] overflow-x-hidden bg-ciza-black text-ciza-ivory">
      ...
      <section id="blog" className="bg-white/[0.025] px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            eyebrow="Blog crypto"
            title="Guides CizaOnline pour apprendre Bitcoin, Binance P2P et la securite crypto."
            text="Des articles courts, pratiques et pedagogiques pour progresser en RDC et en Afrique francophone sans promesse financiere."
          />
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {blogArticles.map((article, index) => (
              <motion.article
                ...
                whileHover={{ y: -5 }}
                transition={{ duration: 0.55, delay: index * 0.06 }}
                className="feature-card rounded-[1.25rem] border border-ciza-gold/16 bg-ciza-graphite p-5 shadow-panel sm:p-6"
              >
                ...
                <a href={article.href} className="mt-6 inline-flex items-center gap-2 text-sm font-black text-ciza-gold">
                  Lire l&apos;article
          ...
          <div className="mt-8 flex justify-center">
            <a href="/blog" className="inline-flex min-h-[3.25rem] items-center justify-center gap-2 rounded-full border border-ciza-gold/25 bg-white/[0.055] px-6 py-3 text-sm font-bold text-white hover:bg-ciza-gold/10">
      ...
      <section id="contact" className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[minmax(0,.9fr)_minmax(0,1.1fr)] lg:items-center">
          ...
          <LeadCaptureForm
            ...
            title="Recevoir un rappel CizaOnline"
            description="Indique ton besoin principal: formation crypto, accompagnement Binance, abonnement premium ou autre demande."
        ...
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-2 lg:grid-cols-[minmax(0,1.12fr)_minmax(0,.7fr)_minmax(0,.78fr)_minmax(0,1.12fr)]">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3 text-sm text-white/52">
              ...
              <a href="/politique-de-confidentialite" className="hover:text-ciza-gold">Politique de confidentialite</a>
              <a href="/conditions-utilisation" className="hover:text-ciza-gold">Conditions d&apos;utilisation</a>
              <a href="/mentions-legales" className="hover:text-ciza-gold">Mentions legales</a>
            </div>
          </div>
          <div>
